...
| Doc | Purpose |
|---|---|
| [RUNBOOK_PAN_LAB.md](pan/RUNBOOK_PAN_LAB.md) / [ps](pan/RUNBOOK_PAN_LAB_PS.md) | Lab Panorama over the API: auth (`panorama_auth.py` for XML, `panorama_rest_auth.py` for REST), config pulls, rule-service tooling |
