# Runbook A — Commands (Clone lm1 → lm2)

Bare commands only. See [RUNBOOK_A.md](RUNBOOK_A.md) for explanations,
or [RUNBOOK_A_COMMANDS_PS.md](RUNBOOK_A_COMMANDS_PS.md) for the Windows PowerShell variant.
