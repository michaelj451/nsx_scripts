# Runbook GROUP REMAP REPORT : Panorama CSV remap dry run : Windows / PowerShell
...
macOS / Linux variant: [RUNBOOK_GROUP_REMAP_REPORT.md](RUNBOOK_GROUP_REMAP_REPORT.md).
...
```powershell
Get-ChildItem pan_reports\pano4 | Sort-Object Name -Descending |
  Select-Object -First 1 | ForEach-Object {
    notepad "$($_.FullName)\group_remap_dryrun\report.md" }
```
